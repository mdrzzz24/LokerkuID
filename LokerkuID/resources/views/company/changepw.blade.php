...
<!-- Sidebar -->
    ...
    <div style="margin-left:15%">
        ...
        <div class="w3-container">
            <center>
                <form action="changepw/{{ Auth::user()->id }}/edit" method="post">
                    @method('put')
                    @csrf
            ...
            <div class="container w-50 text-start mt-5">
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="password" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Old Password" required>
                    </div>
                </div>
            </div>
            <div class="container w-50 text-start">
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="password" class="form-control @error('name') is-invalid @enderror" name="npw" placeholder="New Password" required>
                    </div>
                </div>
            </div>
            <div class="container w-50 text-start">
                <div class="row mb-3">
                    <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Confirmation New Password') }}</label>
                    <div class="col-md-6">
                        <input id="name" type="password" class="form-control @error('name') is-invalid @enderror" name="cnpw" placeholder="Confirmation New Password" required>
                    </div>
                </div>
            </div>
